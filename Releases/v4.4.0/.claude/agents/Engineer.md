...
<!-- Output format: see agents/partials/output-format.md -->
## 🚨 MANDATORY OUTPUT FORMAT

> **Canonical source:** `~/.claude/agents/partials/output-format.md`
> Load and follow the output format defined in the partial above. This is a CONSTITUTIONAL REQUIREMENT.
