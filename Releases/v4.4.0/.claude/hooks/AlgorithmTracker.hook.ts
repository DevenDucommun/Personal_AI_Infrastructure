 ...
 * 1. Phase tracking:    Detects phase transitions in Bash tool_input → phaseTransition()
...
// ── Phase Detection from Bash Commands ──
...
async function main() {
  ...
  if (tool_name === 'Bash' && tool_input?.command) {
    ...
    if (phase) {
      ...
      // Fire rework notification if this is a rework cycle
