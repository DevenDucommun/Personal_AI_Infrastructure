...
```json
{
  ...
  "transcript_path": "/Users/deven.ducommun/.claude/projects/.../2598bd7e.jsonl",
  "cwd": "/Users/deven.ducommun/Projects",
...
HOOK_PATH="/Users/deven.ducommun/.claude/hooks/${HOOK_NAME}"
...
```json
{"type": "command", "command": "/Users/deven.ducommun/.claude/hooks/lib/run-hook.sh HookName.hook.ts"}
```
